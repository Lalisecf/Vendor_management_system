...
import { MultiDropdownRoleComponent } from '../register-actor/multi-dropdown-role/multi-dropdown-role.component';
@Component({
  selector: 'app-update-role-approver',
  templateUrl: './update-role-approver.component.html',
  styleUrls: ['./update-role-approver.component.css']
})
export class UpdateRoleApproverComponent implements OnInit {
      ...
      async (data) => {
        if (data == true) {
          ...
          if (this.user_id != null) {
            ...
            this.router.navigateByUrl('Approver/Approve-pending-users');
