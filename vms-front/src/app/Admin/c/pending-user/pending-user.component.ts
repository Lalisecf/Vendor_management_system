      ...
      columns: [
        ...
        },
        {
          ...
          render: function (data: any, type: any, full: any) {
            ...
            return '<span class="badge bg-success rounded-pill">Approved</span><button class="btn btn-outline-primery btn-rounded mdi mdi-pencil" edit-role="' +
            full.id +
            '"</button>';
            else 
        ...
        // },
        {
          ...
          render: function (data: any, type: any, full: any) {
            ...
            return (
              ...
              {
                return '<span class="text-success"> <i class="mdi mdi-check mr-1"></i>Already Approved on  ' + full.action_date+ '</span>';
              }
              else
              return '<span class="text-danger"><i class="mdi mdi-window-close mr-1"></i>Already Rejected on  ' + full.action_date+ '</span>';
          },
        },
      ],
    ...
    this.renderer.listen('document', 'click', (event) => {
      if (event.target.hasAttribute('edit-user')) {
        this.router.navigateByUrl(
          'Approver/Approve-pending-users/' + event.target.getAttribute('edit-user')
        );
      }  else if (event.target.hasAttribute('edit-role')) {
        this.router.navigateByUrl(
          'Approver/approved-user/' + event.target.getAttribute('edit-role')
        );
