...
export class RegisterActorComponent implements OnInit {
    ...
    this.registerForm = this.formBuilder.group(
      {
        ...
        email: new FormControl('', [
          ...
          Validators.email,
          Validators.pattern('^[a-zA-Z0-9_.]+@aabank.com$'),
        ]),
  ...
  onSubmit() {
    ...
    if (
      ...
      // this.phoneChange(this.registerActorPayload.phonenumber);
      console.log(
  ...
  //   this.adminService.checkPhoneExist(phone).subscribe(
  //     (data: Boolean) => {
  //       if (
  //         data === false
  //       ) {
  //         this.phoneExist = false;
  //             console.log("***************************="+this.phoneExist);
  //       } else {
