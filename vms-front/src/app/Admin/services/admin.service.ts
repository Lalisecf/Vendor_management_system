...
import { timeManagement } from '../payloads/timeManagement';
...
export class AdminService {
  ...
  ApprovedPendingUser(user_id: any): Observable<Boolean> {
    return this.httpClient.get<Boolean>(this.url + 'approved_pending_user/' + user_id);
  }
  ...
  get_name_of_user(name: any): Observable<string> {
    return this.httpClient.get<string>(this.url + 'get_name_of_user/' + name);
  }
  ...
  changeTime(minute: any): Observable<Boolean> {
    return this.httpClient.post<Boolean>(this.url + 'change_session_time', minute);
  }

  changePasswordExpirationTime(day: any): Observable<Boolean> {
    return this.httpClient.post<Boolean>(this.url + 'password_expiration_time', day);
  }

  changeLoginTrial(trial: any): Observable<Boolean> {
    return this.httpClient.post<Boolean>(this.url + 'change_login_trial', trial);
  }
  ...
  getIdleTime(): Observable<timeManagement> {
    return this.httpClient.get<timeManagement>(this.url + 'get_idle_time');
  }
